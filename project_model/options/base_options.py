...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--center', action='store_true', help='only use center part to train')
        # basic parameters
        ...
        parser.add_argument('--netG', type=str, default='unet_Wenxi', help='specify generator architecture [resnet_9blocks | resnet_6blocks | unet_256 | unet_128]')
        ...
        # dataset parameters
        parser.add_argument('--dataset_mode', type=str, default='templatewholehcp', help='chooses how datasets are loaded. [unaligned | aligned | single | colorization]')
